...
// Google Map
	var locations = [
		['<div class="infobox"><h3 class="title"><a href="#contact">OUR USA OFFICE</a></h3><span>NEW YORK CITY 2045 / 65</span><br>+90 555 666 77 88</p></div></div></div>',53.337796,-6.321099]
		];
		...
		var map = new google.maps.Map(document.getElementById('map'), {
		  ...
		  zoom: 18,
			...
			styles: [ { "stylers": [ { "hue": "#27e0ff" },  {saturation: 100},
                {gamma: 1} ] } ],
			center: new google.maps.LatLng(53.337796,-6.321099),
